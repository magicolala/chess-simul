...
@Component({
  ...
  template: `
    <div class="ui-card w-full max-w-md relative bg-white">
      <button (click)="goToRegister.emit()" class="ui-btn ui-btn-ghost absolute -top-12 left-0 text-sm px-3 py-1">← Retour</button>

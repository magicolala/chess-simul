...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-nano-banana text-[#1D1C1C] font-sans flex flex-col">
      <!-- Navbar -->
      <nav
        class="flex items-center justify-between px-6 py-6 border-b-2 border-[#1D1C1C] sticky top-0 bg-white/95 backdrop-blur-sm z-50"
      >
        <div class="flex items-center space-x-3">
          ...
          <h1 class="text-xl font-black font-display tracking-tighter uppercase hidden md:block">
            Chess Master
          </h1>
        </div>
      ...
      <!-- Hero Section -->
      <header
        class="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 relative overflow-hidden"
      >
        <!-- Decorative Background Elements -->
        <div
          class="absolute top-20 left-10 text-9xl opacity-5 pointer-events-none rotate-12 font-display"
        >
          ♟
        </div>
        <div
          class="absolute bottom-20 right-10 text-9xl opacity-5 pointer-events-none -rotate-12 font-display"
        >
          ♞
        </div>

        <div
          class="ui-card max-w-5xl relative z-10 animate-in fade-in zoom-in duration-700 bg-white/80 p-10 md:p-14 backdrop-blur-sm space-y-8"
        >
          <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <span
              class="inline-block py-1 px-3 bg-[#E0F7FA] text-[#006064] border border-[#006064] text-xs font-black font-display uppercase tracking-widest rounded-full"
            >
              Multijoueur Premium
            </span>
            <div
              class="flex items-center justify-center gap-3 text-sm font-bold font-display uppercase text-gray-600"
            >
              <span
                class="inline-flex items-center gap-2 px-3 py-1 border-2 border-[#1D1C1C] bg-[#FFF48D]"
                >⚡ Temps réel</span
              >
              <span
                class="inline-flex items-center gap-2 px-3 py-1 border-2 border-[#1D1C1C] bg-white"
                >♙ 0 bots, 100% humain</span
              >
            </div>
          </div>
          ...
          <h1 class="text-5xl md:text-7xl font-black font-display tracking-tighter leading-[0.95]">
            L'ÉCHECS <br />
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#1D1C1C] to-gray-500"
              >ENTRE AMIS.</span
            >
          </h1>
          <p
            class="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed font-sans"
          >
            Parties rapides, simultanées et analyses visuelles. Lancez un duel en 10 secondes,
            partagez le lien et reprenez vos meilleurs coups depuis n'importe quel appareil.
          </p>

          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 text-left">
            <div class="ui-card p-5 bg-white/90">
              <p class="text-sm font-bold font-display uppercase tracking-wide text-gray-500 mb-2">
                Pour les clubs
              </p>
              <p class="text-lg font-black font-display leading-tight">
                Organisez des simultanées pro et suivez chaque table.
              </p>
            </div>
            <div class="ui-card p-5 bg-white/90">
              <p class="text-sm font-bold font-display uppercase tracking-wide text-gray-500 mb-2">
              ...
              <p class="text-lg font-black font-display leading-tight">
                Invitations instantanées, pas besoin de créer un lobby.
              </p>
            </div>
            <div class="ui-card p-5 bg-white/90">
              <p class="text-sm font-bold font-display uppercase tracking-wide text-gray-500 mb-2">
              ...
              <p class="text-lg font-black font-display leading-tight">
                Export PGN, reprise de parties et mode analyse dédié.
              </p>
            </div>
          </div>

          <div
            class="flex flex-col md:flex-row items-center justify-center md:justify-between gap-6"
          >
      ...
      <section class="py-16 bg-white border-t-2 border-[#1D1C1C]">
        <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
          <div class="lg:col-span-1 space-y-4">
            <p class="text-sm font-black font-display uppercase tracking-[0.2em] text-gray-500">
              Conçu pour jouer
            </p>
            <h2 class="text-4xl font-black font-display leading-tight">
              Une plateforme pensée pour la compétition amicale.
            </h2>
            <p class="text-gray-600 font-medium">
              Accédez à une interface néo-brutaliste, des animations soignées et un suivi clair des
              coups. Le tout en français.
            </p>
            <div class="flex items-center gap-4">
              <span
                class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#FFF48D] border-2 border-[#1D1C1C] font-bold"
                >☑</span
              >
          ...
          <div class="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div
              class="ui-card p-6 space-y-3 bg-[#FFF48D]/30 border-dashed border-2 border-[#1D1C1C]"
            >
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-bold px-3 py-1 border-2 border-[#1D1C1C] bg-white"
                  >Jusqu'à 12 tables</span
                >
              </div>
              <p class="text-gray-700 font-medium">
                Le maestro passe de table en table, les joueurs voient l'avancée en temps réel.
                Idéal pour les clubs et les streams.
              </p>
            ...
            <div class="ui-card p-6 space-y-3 bg-white/80">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-bold px-3 py-1 border-2 border-[#1D1C1C] bg-[#7AF7F7]"
                  >Lien magique</span
                >
              </div>
              <p class="text-gray-700 font-medium">
                Envoyez un lien, la partie s'ouvre directement. Vous choisissez le temps, la couleur
                et l'orientation.
              </p>
              <div class="grid grid-cols-2 gap-4 text-sm font-bold text-gray-800">
                <div class="p-4 border-2 border-[#1D1C1C] bg-[#FFF48D]/60">
            ...
            <div class="ui-card p-6 space-y-3 bg-white/80">
              ...
              <button (click)="goToMemory.emit()" class="w-full ui-btn ui-btn-ghost border-2 border-[#1D1C1C] font-bold">
                Lancer le défi
              </button>
            </div>
            ...
            <div class="ui-card p-6 space-y-3 bg-[#1D1C1C] text-white border-4 border-[#FFF48D]">
              ...
              <p class="text-gray-100 font-medium">
                Interface responsive, optimisée mobile. Les animations restent fluides, même lors
                des simultanées.
              </p>
              <div class="flex items-center gap-4">
                <div class="text-3xl">📱</div>
                <p class="font-black font-display leading-tight">
                  Accessible sur tablette et smartphone sans installer quoi que ce soit.
                </p>
              </div>
            </div>
          </div>
      ...
      <section class="py-16 bg-nano-banana border-t-2 border-[#1D1C1C]">
        <div class="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center gap-10">
          <div class="flex-1 space-y-4">
            <p class="text-sm font-black font-display uppercase tracking-[0.25em] text-gray-600">
              Communauté
            </p>
            <h3 class="text-4xl font-black font-display leading-tight">
              Rejoignez les joueurs qui aiment le beau jeu.
            </h3>
            <p class="text-gray-700 font-medium">
              Un lobby social, des profils publics et un historique clair pour challenger vos amis
              encore et encore.
            </p>
            <div class="flex items-center gap-6">
              ...
              <div>
                ...
                <p class="text-xs font-bold uppercase tracking-widest text-gray-600">
                  Note moyenne des parties privées
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
            <div class="ui-card p-6 bg-white/90 border-2 border-[#1D1C1C]">
              ...
              <p class="font-black text-lg leading-tight">
                « Les simultanées sont super lisibles, on voit immédiatement où jouer ensuite. »
              </p>
            ...
            <div class="ui-card p-6 bg-[#FFF48D]/80 border-2 border-[#1D1C1C]">
              ...
              <p class="font-black text-lg leading-tight">
                « On s'envoie un lien et on joue sur mobile. L'historique est nickel pour se vanner
                après. »
              </p>
            ...
            <div class="ui-card p-6 bg-white/90 border-2 border-[#1D1C1C] sm:col-span-2">
              ...
              <p class="font-black text-lg leading-tight">
                « La DA néo-brutaliste fait la diff en stream, et la reprise de parties marche très
                bien entre deux lives. »
              </p>
      ...
      <section class="py-12 bg-[#1D1C1C] text-white border-t-2 border-[#1D1C1C]">
        ...
        >
          <div>
            <p class="text-sm font-black font-display uppercase tracking-[0.3em] text-[#FFF48D]">
              Prêt à jouer
            </p>
            <h4 class="text-3xl md:text-4xl font-black font-display leading-tight">
              Créez une partie privée en moins de 10 secondes.
            </h4>
            <p class="text-gray-200 font-medium mt-2">
              Aucune carte bancaire demandée. Votre progression reste disponible partout.
            </p>
          </div>
      ...
      <footer class="bg-[#1D1C1C] text-white py-12 border-t-2 border-[#1D1C1C]">
        <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <div class="flex items-center space-x-3 mb-4 md:mb-0">
            <div
              class="w-8 h-8 bg-[#FFF48D] text-[#1D1C1C] flex items-center justify-center border border-white font-bold"
            >
              ♟
            </div>
            <span class="font-black font-display tracking-tight text-lg">CHESS MASTER</span>
          </div>
          <p class="text-gray-400 text-sm font-medium font-sans">
            © 2024 Chess Master. Design Néo-Brutaliste.
          </p>
        </div>
      </footer>
    </div>

                ...
                <div class="flex flex-col md:flex-row items-center md:items-start gap-8 relative z-10">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <div class="flex flex-wrap justify-center md:justify-start gap-3">
                            ...
                            @if (!isMe(profile.id)) {
                                <button class="ui-btn ui-btn-dark px-4 py-1 text-xs">
                                    Ajouter en ami
                                </button>
                                <button class="ui-btn ui-btn-ghost px-4 py-1 text-xs">
                                    Message
                                </button>
                            }
                        </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div class="ui-card p-4 wero-shadow-sm hover:translate-y-[-2px] transition-transform">
                    ...
                    <div>
                         ...
                         <div class="flex flex-wrap gap-4">
                             @for (badge of profile.badges; track badge.id) {
                                 <div class="ui-card p-3 flex items-center space-x-3 pr-6 rounded-[2px] group relative cursor-help bg-gray-50 dark:bg-[#121212]">
